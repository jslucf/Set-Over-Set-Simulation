...
### This step just creates a deck where the numbers represent ranks of cards (1:4 are deuces, 5:8 are threes, etc.). It also names an index in the form "rk.2", 
"rk.3", etc.
```{r}
...
1       no.set 441285 0.882570
2     only.set  56324 0.112648
3  was.overset   1156 0.002312
4 was.underset   1235 0.002470
